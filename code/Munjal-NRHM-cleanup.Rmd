...
<li>
Developed a clean [rubric template of the survey](https://github.com/grmunjal/socialcops/data/)

<li>
Extracted all .xls files given into a [single folder](https://github.com/grmunjal/socialcops/data/xls-files/) using bash
```{r}
...
```
<li>
Developed a [Python based parser](https://github.com/grmunjal/socialcops/code/) that takes an excel file, fishes out all the data and labels the rows according to the rubric
...
<li>
Output from parser is a "tidy" .csv file that is R readable. File names for the tidy files match the Facility Name inside the spreadsheet. [One file produced per xls provided](https://github.com/grmunjal/socialcops/data/tidy-files/). 
...
<li> Final file is [here (tidy-NRHM-compiledset.csv)](https://github.com/grmunjal/socialcops/data/xls-files/)
<br><br><br><br>
