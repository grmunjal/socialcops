...
<li>
Extracted all .xls files given into a [single folder](https://github.com/grmunjal/socialcops/tree/master/dataxls-files/) using bash
```{r}
...
<li>
Output from parser is a "tidy" .csv file that is R readable. File names for the tidy files match the Facility Name inside the spreadsheet. [One file produced per xls provided](https://github.com/grmunjal/socialcops/tree/master/datatidy-files/). 
